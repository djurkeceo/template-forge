  ...
  return (
    <section aria-labelledby="hero-alt-title" className="relative overflow-hidden">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <MorphBlob className="absolute left-1/2 top-0 h-72 w-[42rem] -translate-x-1/2 bg-verdant-tint blur-3xl dark:bg-verdant/15" />
      </div>
      <div className="relative mx-auto max-w-3xl px-5 pb-14 pt-12 text-center sm:pt-16">
        ...
        >
          <SplitText text="Fill every seat without chasing anyone." />
        </h1>
